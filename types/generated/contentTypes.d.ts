...
export interface ApiAboutusAboutus extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'block.pagecard', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heading: Schema.Attribute.Component<'block.pagecard', false>;
    journey: Schema.Attribute.DynamicZone<['block.journey-card']>;
    leadership: Schema.Attribute.DynamicZone<['support.employecard']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::aboutus.aboutus'
...
export interface ApiAgreementAgreement extends Struct.SingleTypeSchema {
  ...
  attributes: {
    agreebody: Schema.Attribute.DynamicZone<
      [
        'support.image-right',
        'support.image-left',
        'support.faq',
...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    faqbody: Schema.Attribute.DynamicZone<
      [
        'support.faq',
        'block.description',
        'block.tipwarn',
...
export interface ApiFaqtypeFaqtype extends Struct.CollectionTypeSchema {
  collectionName: 'faqtypes';
  info: {
    displayName: 'Faqtype';
    pluralName: 'faqtypes';
    singularName: 'faqtype';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGamepageGamepage extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'gamecategoty';
    pluralName: 'gamepages';
    singularName: 'gamepage';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlaygamePlaygame extends Struct.CollectionTypeSchema {
  collectionName: 'playgames';
  info: {
    displayName: 'playgame';
    pluralName: 'playgames';
    singularName: 'playgame';
  };
  options: {
    draftAndPublish: true;
  };
